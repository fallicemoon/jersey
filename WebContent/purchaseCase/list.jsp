...
<body>
  ...
  <form action="/jersey/PurchaseCaseServlet" method="POST">
    ...
    <a href="/jersey/purchaseCase/add.jsp"><button type="button" class="btn btn-success" data-toggle="modal">新增</button></a>
  	<button type="submit" name="action" value="delete" class="btn btn-danger" data-toggle="modal" onclick="return confirm('確認刪除?')">刪除</button>
  	<a href="/jersey/purchaseCase/list.jsp?action=getProgressNotComplete"><button type="button" class="btn btn-normal">進貨未完成</button></a>
  <table border=1 width="1500px" class="table table-hover">
    ...
    <tr>
	  ...
	  <td>
  	  ...
  	  <td>
		<a href="/jersey/purchaseCase/update.jsp?purchaseCaseId=${vo.purchaseCaseId}"><button type="button" class="btn btn-warning">修改</button></a>
  	  </td>
